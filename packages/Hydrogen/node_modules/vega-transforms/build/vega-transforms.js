(function (global, factory) {
  ...
  var prototype$28 = WindowState.prototype;

  prototype$28.init = function() {
    this.windows.forEach(function(_) { _.init(); });
    if (this.cell) this.cell.init();
  };

  prototype$28.update = function(w, t) {
    var self = this,
        cell = self.cell,
        wind = self.windows,
        data = w.data,
  ...
  var prototype$29 = vegaUtil.inherits(Window, vegaDataflow.Transform);
  ...
  prototype$29.group = function(key) {
    var self = this,
